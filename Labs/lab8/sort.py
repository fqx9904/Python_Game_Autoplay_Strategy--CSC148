...
def selection_sort(list_: list) -> None:
    ...
    for i in range(list_len):
        ...
        smallest = list_.index(min(list_[i:]))
...
if __name__ == '__main__':
    import cProfile
    import timeit
    cProfile.run('selection_sort([i for i in range(1000)])')
    t = timeit.timeit('selection_sort([i for i in range(1000)])',
                      'from sort import *', number=10)
    print(t)
